...
export const POST = withApiErrorHandling('mobile-upload:create', async function POST(req: Request) {
  ...
  if (!detectedType || !ALLOWED_TYPES.includes(detectedType)) {
    throw badRequest(`File type not allowed: ${detectedType}`)
  }
